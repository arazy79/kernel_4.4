...
static const struct freq_tbl ftbl_gfx3d_clk_src[] = {
    ...
    F_GFX(600000000, 0,  2, 0, 0,  860000000),  /* bridge: test above 585M with sf 860M */
    F_GFX(620000000, 0,  2, 0, 0,  860000000),  /* bridge: test sf 930M threshold */
	F_GFX(647000000, 0,  2, 0, 0,  860000000),
	F_GFX(700000000, 0,  2, 0, 0,  860000000),
	F_GFX(725000000, 0,  2, 0, 0,  860000000),
	F_GFX(750000000, 0,  2, 0, 0,  860000000),
    F_GFX(850000000, 0,  2, 0, 0,  860000000),
	{ }
};
